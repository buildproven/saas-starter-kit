...
const features = [
  {
    ...
    description:
      'Built with Next.js 16 App Router for optimal performance and developer experience.',
  },
  {
    icon: Shield,
...
export default function MarketingPage() {
  ...
  const handleGetStarted = useCallback(
    (planId: string) => {
      if (planId === 'free') {
        window.location.href = user ? '/dashboard' : '/auth/signin'
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              A complete Next.js 16 SaaS starter with authentication, billing, multi-tenancy, and
